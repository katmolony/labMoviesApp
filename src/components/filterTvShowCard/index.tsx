...
import { FilterOption, GenreDataTV } from "../../types/interfaces";
...
const FilterTvShowCard: React.FC<FilterTvShowsCardProps> = ({
  titleFilter,
  genreFilter,
  onUserInput,
}) => {
  const { data, error, isLoading, isError } = useQuery<GenreDataTV, Error>(
    "tvgenres",
    getTvShowGenres
  );
